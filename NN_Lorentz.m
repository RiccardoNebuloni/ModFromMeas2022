...
for l=1:numel(rho_test)
    ...
    rho_tested=[rho_tested;rho_test(l)*ones(k*numel(t),1)];
end
...
figure(3)
subplot(3,1,1), plot(t,y_L(:,1),t,ynn(:,2),'Linewidth',[2]),legend('ODE45','NN'),xlabel('t'); ylabel('x');
subplot(3,1,2), plot(t,y_L(:,2),t,ynn(:,3),'Linewidth',[2]),legend('ODE45','NN'),xlabel('t'); ylabel('y');
subplot(3,1,3), plot(t,y_L(:,3),t,ynn(:,4),'Linewidth',[2]),legend('ODE45','NN'),xlabel('t'); ylabel('z');
